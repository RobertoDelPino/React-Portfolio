    ...
    return (
        <>
            <section id="about" className="dark:bg-gray-800 flex flex-col flex-grow">
                ...
                <section className="dark:bg-gray-800 max-w-screen-xl my-0 mx-auto lg:px-8 px-4 py-4 flex flex-wrap">
                    <div className="mr-10">
                        <article role="region" aria-label="About me region" className=" mb-8 mt-0">
                            <h1 className="text-2xl font-extrabold tracking-wide dark:text-title-dark my-4 mb-8">Sobre mi</h1>
                        ...
                        <article role="region" aria-label="Education region" className="mt-24">
                   ...
                   <div>
                        ...
                        <article role="region" aria-label="Events region " className="mb-8 mt-12">
