...
export const EducationCard = ({education}: EducationCardProps) => <section>
    <article className="hidden md:block border-b-2 border-black dark:border-white pb-4 mt-3">
        ...
        <article className="md:flex justify-between">
            ...
            {education.certicateUrl && <a href={education.certicateUrl} target="_blank" className="w-28 block"><p className="p-1 rounded-xl mt-3 bg-slate-300 hover:bg-slate-400 dark:bg-slate-400 dark:hover:bg-slate-300 w-28 text-center text-sm font-semibold ">Ver certificado</p></a>}
        </article>
    </article>
    ...
    <article className="block md:hidden border-b-2 border-black dark:border-white pb-4 my-8">
        <article className="flex justify-between">
            ...
            {education.certicateUrl && <a href={education.certicateUrl} target="_blank" className="w-28 block"><p className="p-1 rounded-xl bg-slate-300 hover:bg-slate-400 dark:bg-slate-400 dark:hover:bg-slate-300 w-28 text-center text-sm font-semibold ">Ver certificado</p></a>}
        </article>
