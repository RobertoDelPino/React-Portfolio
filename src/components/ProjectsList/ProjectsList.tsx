    ...
    <section role="region" aria-label="Project List Section" className="flex justify-center flex-wrap mt-5">
        {
            list.map((project: Project, index) => (
                <article role="article" aria-label="Project" key={index} className="m-3 w-52 md:w-72 dark:bg-gray-600 rounded-2xl border-2 dark:border-0">
                    ...
                    <article className="p-4">
                        ...
                        <section className="mt-3 md:flex h-10 mb-5 md:mb-0">
                            ...
                            <p> <BsGithub className="inline h-[100%]"/> <a className="h-[100%] mr-4 text-center underline" target="_blank" href={project.githubUrl}>Ver código</a> </p>
                        </section>
                    </article>
                </article>
            ))
