...
export const ScrollToTopButton = () => {
    ...
    return (
        isVisible && (
            <button className="fixed bottom-4 right-3 transition duration-300 p-1 hover:-translate-y-1 bg-gray-200 hover:bg-gray-300 dark:bg-gray-100 hover:dark:bg-gray-300" onClick={scrollToTop}>
